...
--
-- Name: worldcup; Type: DATABASE; Schema: -; Owner: david
--

CREATE DATABASE worldcup WITH TEMPLATE = template0 ENCODING = 'SQL_ASCII' LOCALE_PROVIDER = libc LOCALE = 'C';


ALTER DATABASE worldcup OWNER TO david;
...
--
-- Name: games; Type: TABLE; Schema: public; Owner: david
--
...
ALTER TABLE public.games OWNER TO david;

--
-- Name: games_game_id_seq; Type: SEQUENCE; Schema: public; Owner: david
--
...
ALTER TABLE public.games_game_id_seq OWNER TO david;

--
-- Name: games_game_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: david
--
...
--
-- Name: teams; Type: TABLE; Schema: public; Owner: david
--
...
ALTER TABLE public.teams OWNER TO david;

--
-- Name: teams_team_id_seq; Type: SEQUENCE; Schema: public; Owner: david
--
...
ALTER TABLE public.teams_team_id_seq OWNER TO david;

--
-- Name: teams_team_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: david
--
...
--
-- Name: games game_id; Type: DEFAULT; Schema: public; Owner: david
--
...
--
-- Name: teams team_id; Type: DEFAULT; Schema: public; Owner: david
--
...
--
-- Data for Name: games; Type: TABLE DATA; Schema: public; Owner: david
--
...
--
-- Name: games_game_id_seq; Type: SEQUENCE SET; Schema: public; Owner: david
--
...
--
-- Name: teams_team_id_seq; Type: SEQUENCE SET; Schema: public; Owner: david
--
...
--
-- Name: games games_pkey; Type: CONSTRAINT; Schema: public; Owner: david
--
...
--
-- Name: teams teams_name_key; Type: CONSTRAINT; Schema: public; Owner: david
--
...
--
-- Name: teams teams_pkey; Type: CONSTRAINT; Schema: public; Owner: david
--
...
--
-- Name: games games_opponent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: david
--
...
--
-- Name: games games_winner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: david
--
